...
def main():
    ...
    # Delete from back to front,Avoid index misalignment
    ...
    # Reconstruct parameters to use model paths as positional parameters
    ...
    # Use os.systemCall to start the lmdeploy server
