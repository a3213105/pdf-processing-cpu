...
class Im2Seq(nn.Module):
    ...
    # def forward(self, x):
    #     B, C, H, W = x.shape
    #     # Process four-dimensional tensors, flattening spatial dimensions into sequences
    #     if H == 1:
    #         # The original processing logic is applicable to H=1situation
    #         x = x.squeeze(dim=2)
    #         x = x.permute(0, 2, 1)  # (B, W, C)
    #     else:
    #         # Handle the situation when H is not 1
