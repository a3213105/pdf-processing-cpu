...
class RapidTableModel():
    ...
    def predict(self, image, ocr_result=None):
        ...
        if not ocr_result:
            ...
            # Separate bounding boxes, text and confidence
            boxes = []
            texts = []
            scores = []
            ...
            # according to rapid_table expected format build ocr_results
    ...
    def batch_predict(self, table_res_list: List[dict], batch_size: int = 4):
        ...
        if not_none_table_res_list:
            ...
            ocr_results = []
            # ocr_resultsNeeds to be built in the format expected by rapid_table
