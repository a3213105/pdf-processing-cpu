...
class TableMatch:
    ...
    def decode_logic_points(self, pred_structures):
        ...
        max_rows = 0
        max_cols = 0
        occupied_cells = {}  # Used to record occupied cells
        ...
        while i < len(pred_structures):
            ...
            if token == "<tr>":
                current_col = 0  # every time you encounter <tr> When, reset the current column number
            elif token == "</tr>":
                current_row += 1  # End of line, line number incremented
                ...
                if token != "<td></td>":
                    j += 1
                    # extract colspan and rowspan property
                ...
                # Skip properties that have already been processed token
                i = j
