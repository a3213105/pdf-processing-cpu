...
class RapidTable:
    ...
    def predict(
        ...
        # Adapt box scaling restoration to the output of the slicet-plus model
...
class RapidTableModel(object):
    ...
    def batch_predict(self, table_res_list: List[Dict], batch_size: int = 4, tqdm_enable: bool = False) -> None:
        """Perform batch prediction on the passed dictionary list, no return value"""
